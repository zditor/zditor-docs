...
Nativer Agent, leichtgewichtig, leistungsstark, Schreiben und Zeichnen in einem
<br>
</h1>
<br/>
<p align="center">
Leichtgewichtig, leistungsstark, KI-gestuetzt, Schreiben und Zeichnen in einem, WYSIWYG<br />
Local-first, dateibasiert, bidirektionale Links
</p>
...
<p align="center">Willkommen bei Zditor, einem KI-erweiterten Markdown-Editor.</p>

<p align="center">Dieses Repository enthaelt die Markdown-Dokumentation von Zditor. Auf dem Branch <code>docs</code> findest du die Rich-Text-Version.</p>
...
Zditor ist ein WYSIWYG-Markdown-Editor, der Standard-Markdown unterstuetzt und um strukturierte Dokumentfunktionen erweitert. Aktuell werden `Windows`, `macOS` und `Linux` unterstuetzt.

Downloads gibt es auf der [Releases-Seite](https://github.com/zditor/zditor-docs/releases) oder auf der [offiziellen Website](https://zditor.com).
...
- [Mathematik Formelsammlung](german/mathematik/Mathematik%20Formelsammlung.md)
- [Statistik Formelsammlung](german/mathematik/Statistik%20Formelsammlung.md)
- [Lineare Algebra Formelsammlung](german/mathematik/Lineare%20Algebra%20Formelsammlung.md)
- [Klassische Physik Formelsammlung](german/mathematik/Klassische%20Physik%20Formelsammlung.md)
- [Chemie Formeln und Reaktionen](german/mathematik/Chemie%20Formeln%20und%20Reaktionen.md)
- [Deep Learning Formelsammlung](german/mathematik/Deep%20Learning%20Formelsammlung.md)

### Filme

- [Der Pate](german/filme/Der%20Pate.md)
- [Citizen Kane](german/filme/Citizen%20Kane.md)
- [Das Fenster zum Hof](german/filme/Das%20Fenster%20zum%20Hof.md)
- [Psycho](german/filme/Psycho.md)
- [Ganzes Filmverzeichnis](german/filme/)
...
Root-README-Dateien in anderen Sprachen:
