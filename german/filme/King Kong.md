...
genre:
  ...
  description:
  label: Genre
  value: ["Abenteuer", "Fantasy", "Horror"]
...
## Ein klarer Einstieg in King Kong

*King Kong* ist ein Film aus dem Jahr 1933, inszeniert von Merian C. Cooper, und laesst sich gut als Beispiel fuer Abenteuer und Fantasy lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Fay Wray, Robert Armstrong, Bruce Cabot tragen die Praesenz des Films, waehrend AFI-Rang 41 und eine Douban-Wertung von 7.8 den Stellenwert im Kanon noch einmal sichtbar machen.
