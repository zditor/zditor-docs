...
cast:
  ...
  description:
  label: Besetzung
  value: ["Natalie Wood", "Richard Beymer", "George Chakiris"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in West Side Story

*West Side Story* ist ein Film aus dem Jahr 1961, inszeniert von Robert Wise, und laesst sich gut als Beispiel fuer Musical und Romanze lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Natalie Wood, Richard Beymer, George Chakiris tragen die Praesenz des Films, waehrend AFI-Rang 51 und eine Douban-Wertung von 8 den Stellenwert im Kanon noch einmal sichtbar machen.
