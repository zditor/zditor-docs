...
cast:
  ...
  description:
  label: Besetzung
  value: ["Liza Minnelli", "Michael York", "Joel Grey"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in Cabaret

*Cabaret* ist ein Film aus dem Jahr 1972, inszeniert von Bob Fosse, und laesst sich gut als Beispiel fuer Musical und Drama lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Liza Minnelli, Michael York, Joel Grey tragen die Praesenz des Films, waehrend AFI-Rang 63 und eine Douban-Wertung von 8 den Stellenwert im Kanon noch einmal sichtbar machen.
