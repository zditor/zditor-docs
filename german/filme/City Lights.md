...
cast:
  ...
  description:
  label: Besetzung
  value: ["Charlie Chaplin", "Virginia Cherrill", "Harry Myers"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in City Lights

*City Lights* ist ein Film aus dem Jahr 1931, inszeniert von Charlie Chaplin, und laesst sich gut als Beispiel fuer Komoedie und Romanze lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Charlie Chaplin, Virginia Cherrill, Harry Myers tragen die Praesenz des Films, waehrend AFI-Rang 11 und eine Douban-Wertung von 9 den Stellenwert im Kanon noch einmal sichtbar machen.
