...
cast:
  ...
  description:
  label: Besetzung
  value: ["Dustin Hoffman", "Jessica Lange", "Teri Garr"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in Tootsie

*Tootsie* ist ein Film aus dem Jahr 1982, inszeniert von Sydney Pollack, und laesst sich gut als Beispiel fuer Komoedie und Romanze lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Dustin Hoffman, Jessica Lange, Teri Garr tragen die Praesenz des Films, waehrend AFI-Rang 69 und eine Douban-Wertung von 7.6 den Stellenwert im Kanon noch einmal sichtbar machen.
