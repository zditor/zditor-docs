...
genre:
  ...
  description:
  label: Genre
  value: ["Science-Fiction", "Mystery", "Drama"]
...
## Ein klarer Einstieg in Blade Runner

*Blade Runner* ist ein Film aus dem Jahr 1982, inszeniert von Ridley Scott, und laesst sich gut als Beispiel fuer Science-Fiction und Mystery lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Harrison Ford, Rutger Hauer, Sean Young tragen die Praesenz des Films, waehrend AFI-Rang 97 und eine Douban-Wertung von 8.3 den Stellenwert im Kanon noch einmal sichtbar machen.
