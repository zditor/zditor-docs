...
authors:
  ...
  description: 艺术家列表
  label: 艺术家
  value: ["Vienna Philharmonic", "Herbert von Karajan"]
  default: []
release_date:
  type: date
  description: 发行日期
...
title:
  ...
  description: 专辑标题
  label: 标题
  value: "New Year's Concert 1994"
  default: ""
translators:
  type: array
  description: 制作人列表
  label: 制作人
  value: ["Deutsche Grammophon"]
  default: []
updated:
  type: datetime
...
series:
  ...
  description: 丛书系列
  label: 系列
  value: "Vienna New Year's Concert"
  default: ""
location:
  type: text
  description: 存放位置
