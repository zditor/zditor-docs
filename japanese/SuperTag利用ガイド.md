...
このガイドでは、実例として [english/movies/](../english/movies/) の映画クラスを使います。
...
[The Godfather](../english/movies/The%20Godfather.md) を参照してください。
...
この共通値があることで、Zditor は `ClassicMovieEnglish` の文書を 1 つのテーブルとして扱えます。たとえば [Chinatown](../english/movies/Chinatown.md) のような新規文書も、同じ `class` を使えば自動的に同じグループに入ります。
...
たとえば [The Godfather](../english/movies/The%20Godfather.md) には次のような内容があります。
...
表示例: [ClassicMovieEnglish](/english/movies/The%20Godfather.md|mode=supertag)
...
1. [The Godfather](../english/movies/The%20Godfather.md) のような既存ファイルをコピーする
