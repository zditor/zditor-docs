...
genre:
  ...
  description:
  label: Genre
  value: ["Mystery", "Thriller", "Romanze"]
...
## Ein klarer Einstieg in Vertigo

*Vertigo* ist ein Film aus dem Jahr 1958, inszeniert von Alfred Hitchcock, und laesst sich gut als Beispiel fuer Mystery und Thriller lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. James Stewart, Kim Novak, Barbara Bel Geddes tragen die Praesenz des Films, waehrend AFI-Rang 9 und eine Douban-Wertung von 8.5 den Stellenwert im Kanon noch einmal sichtbar machen.
