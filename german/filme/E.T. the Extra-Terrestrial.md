...
genre:
  ...
  description:
  label: Genre
  value: ["Science-Fiction", "Abenteuer"]
...
## Ein klarer Einstieg in E.T. the Extra-Terrestrial

*E.T. the Extra-Terrestrial* ist ein Film aus dem Jahr 1982, inszeniert von Steven Spielberg, und laesst sich gut als Beispiel fuer Science-Fiction und Abenteuer lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Henry Thomas, Drew Barrymore, Dee Wallace tragen die Praesenz des Films, waehrend AFI-Rang 24 und eine Douban-Wertung von 8.4 den Stellenwert im Kanon noch einmal sichtbar machen.
