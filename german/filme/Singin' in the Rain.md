...
cast:
  ...
  description:
  label: Besetzung
  value: ["Gene Kelly", "Donald O'Connor", "Debbie Reynolds"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in Singin' in the Rain

*Singin' in the Rain* ist ein Film aus dem Jahr 1952, inszeniert von Stanley Donen, und laesst sich gut als Beispiel fuer Komoedie und Musical lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Gene Kelly, Donald O'Connor, Debbie Reynolds tragen die Praesenz des Films, waehrend AFI-Rang 5 und eine Douban-Wertung von 8.4 den Stellenwert im Kanon noch einmal sichtbar machen.
