...
cast:
  ...
  description:
  label: Besetzung
  value: ["Marilyn Monroe", "Tony Curtis", "Jack Lemmon"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in Some Like It Hot

*Some Like It Hot* ist ein Film aus dem Jahr 1959, inszeniert von Billy Wilder, und laesst sich gut als Beispiel fuer Komoedie und Romanze lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Marilyn Monroe, Tony Curtis, Jack Lemmon tragen die Praesenz des Films, waehrend AFI-Rang 22 und eine Douban-Wertung von 8.5 den Stellenwert im Kanon noch einmal sichtbar machen.
