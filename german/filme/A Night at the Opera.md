...
cast:
  ...
  description:
  label: Besetzung
  value: ["Groucho Marx", "Harpo Marx", "Chico Marx"]
country:
  type: text
  description:
  label: Land
...
## Ein klarer Einstieg in A Night at the Opera

*A Night at the Opera* ist ein Film aus dem Jahr 1935, inszeniert von Sam Wood, und laesst sich gut als Beispiel fuer Komoedie und Musical lesen. Neben der eigentlichen Handlung zeigt der Film auch, wie klassisches Kino ueber Bildaufbau, Rhythmus und Figurenkonstellationen seine Wirkung entfaltet.

Als Film aus USA verbindet das Werk formale Klarheit mit einer starken Konzentration auf Beziehungen, Entscheidungen und innere Spannungen. Groucho Marx, Harpo Marx, Chico Marx tragen die Praesenz des Films, waehrend AFI-Rang 85 und eine Douban-Wertung von 7.9 den Stellenwert im Kanon noch einmal sichtbar machen.
